...
?>
	...
	<?php endif; ?>
		...
		<div class="ak-container">
			<h1 class="site-info">
				<a href="<?php echo esc_url( __( '#', 'accesspresslite' ) ); ?>"><?php _e( 'Proudly Developed By', 'accesspresslite' ); ?></a>
				<span class="sep"> | </span>
				<a href="<?php echo esc_url('#');?>" title="AccessPress Themes" target="_blank">Al Nahian</a>
			</h1><!-- .site-info -->
